...
var snow = new Array();
snow[0] = "/frontend/plugins/bubble/bubble.gif";
snow[1] = "/frontend/plugins/bubble/bubble.gif";
snow[2] = "/frontend/plugins/bubble/bubble.gif";
...
{
                        document.write("<div id=\"dot"+ i +"\" style=\"z-index:100;POSITION: absolute; Z-INDEX: "+ i +"VISIBILITY: visible; TOP: 15px; LEFT: 15px; width:1;\"><img src=\"" + snow[j] + "\" border=\"0\"></div>");
                } else {
                        document.write("<div id=\"dot"+ i +"\" style=\"z-index:100;POSITION: absolute; Z-INDEX: "+ i +"VISIBILITY: visible; TOP: 15px; LEFT: 15px; width:1;\"><img src=\"" + snow[j] + "\" border=\"0\"></div>");
                }
        }
